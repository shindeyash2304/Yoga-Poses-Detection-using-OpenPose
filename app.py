...
def classifyPose(landmarks, output_image, display=False):
    ...
    torso_angle = calculateAngle(landmarks[mp_pose.PoseLandmark.LEFT_HIP.value],
                                 landmarks[mp_pose.PoseLandmark.LEFT_SHOULDER.value],
                                 landmarks[mp_pose.PoseLandmark.LEFT_EAR.value])  # Using EAR as an approx. neck marker.
   ...
   (30 < torso_angle < 50) and \
   (170 < left_leg_angle < 190 and 170 < right_leg_angle < 190):
        label = 'Cobra Pose (Bhujangasana)'
